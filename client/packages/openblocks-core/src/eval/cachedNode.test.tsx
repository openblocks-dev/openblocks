...
describe("CachedNode", () => {
  ...
  it("wrapContext: evalNodeOrMinor", () => {
    ...
    expect(new WrapContextNode(evalNodeOrMinor(x1, x2)).evaluate()({ i: 2 })).toStrictEqual(2);
    expect(new WrapContextNode(evalNodeOrMinor(x1, x2)).evaluate()({ i: 2 })).toStrictEqual("0");
    expect(new WrapContextNode(evalNodeOrMinor(x1, x2)).evaluate()({ i: 2 })).toStrictEqual("0");
    expect(new WrapContextNode(evalNodeOrMinor(x1, x2)).evaluate()({ i: 1 })).toStrictEqual(1);
    expect(new WrapContextNode(evalNodeOrMinor(x1, x2)).evaluate()({ i: 1 })).toStrictEqual("0");
    expect(new WrapContextNode(evalNodeOrMinor(x1, x2)).evaluate()({ i: 1 })).toStrictEqual("0");
    expect(new WrapContextNode(evalNodeOrMinor(x1, x2)).evaluate()({ i: 3 })).toStrictEqual(3);
  });
});
