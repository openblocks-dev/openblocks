...
const MainWrapper = styled.div<{
  ...
  margin-top: ${(props) =>
    ...
    (props.position === "column-reverse" && props.hasLabel)
      ? "4px"
      : 0};
  height: ${(props) =>
    props.position === "column" ||
  ...
  display: flex;
  align-items: ${(props) =>
    props.position === "row" || props.position === "row-reverse"
      ? "center"
      : "start"};
  flex-shrink: 0;
`;
...
const PositionOptions = [
  ...
  { label: trans("labelProp.right"), value: "row-reverse" },
  { label: trans("labelProp.top"), value: "column" },
  { label: trans("labelProp.bottom"), value: "column-reverse" },
] as const;
          ...
          <MainWrapper position={props.position} hasLabel={!!props.text}>
            ...
            <ChildrenWrapper
              style={{
                ...
                height:
                  props.position === "column" ||
                  (props.position === "column-reverse" && !!props.text)
                    ? "calc(100% - 22px)"
                    : "100%",
              }}
            >
