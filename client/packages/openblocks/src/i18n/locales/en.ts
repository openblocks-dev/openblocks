export const en = {
  ...
  query: {
    ...
    method: "Method",
    updateExceptionDataSourceTitle: "Update the exception data source",
    updateExceptionDataSourceContent:
      "Whether to update the following query with the same exception data source: {query}",
    update: "Update",
  ...
  smtpQuery: {
    ...
    blindCarbonCopy: "Bilnd carbon copy",
    subject: "Subject",
    content: "Content",
  ...
  memberSettings: {
    ...
    moveOutOrg: "Moving out of the workspace",
  ...
  orgSettings: {
    ...
    inviteSuccessMessage: "Successfully join the company",
    inviteFailMessage: "Invited to join the enterprise failure",
  ...
  createAppButton: {
    ...
    newAppPrefix: "{userName}'s new {appName}",
    newNavLayoutPrefix: "{userName}'s {appName}",
    creating: "Creating...",
    created: "Create {name}",
  },
  apiMessage: {
  ...
  aggregation: {
    ...
    hideWhenNoPermission: "Hidden when no application permission",
  ...
  home: {
    ...
    databaseName: "Database name",
    nameCheckMessage: "The name cannot be empty",
    deleteElementTitle: "Delete {name}",
    moveToTrashSubTitle: "This {name} will be moved to trash.",
    deleteElementSubTitle: "Delete {name} is permanent, It cannot be undone.",
    ...
    orgName: "{orgName}-workspace administrator",
    addMember: "Add members",
