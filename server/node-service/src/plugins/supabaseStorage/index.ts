...
import spec from "./supabaseStorage.spec.json";
...
const supabaseStoragePlugin: DataSourcePlugin<any, DataSourceConfigType> = {
  id: "supabaseStorage",
  name: "Supabase Storage",
  icon: "supabaseStorage.svg",
  category: "api",
  dataSourceConfig,
  queryConfig: async () => {
...
export default supabaseStoragePlugin;
